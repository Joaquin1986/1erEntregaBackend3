...
class ProductControllers {
    ...
    static async getProducts(req, res) {
        ...
        let response;
        try {
            const unformattedUsers = await ProductServices.getPaginatedProducts(criteria, options);
            response = buildResponse(ProductRepository.formatProductsArray(unformattedUsers), 'api', sort, category);
    ...
    static async getProductById(req, res) {
        ...
        try {
            const product = await
                ProductRepository.getProduct(pid);
